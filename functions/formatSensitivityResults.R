...
#' data are converted to long format, values of 1000 (meaning no detection) are converted to NA, the 
...
#'
#' @param x (class data frame) output from runSurveillanceSensitivity.
#' 
...
#' obtained from input list of sensitivity analysis configuration parameters.
#'
