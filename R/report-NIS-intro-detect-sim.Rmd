...
p1 <- ggplot2::ggplot(df_probs, aes(x = p_establish)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = 0.05, colour = "black", fill = "gray") +
  theme_bw() +
...
p1 <- ggplot2::ggplot(df_visits, aes(x = site_visit_rate_A)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = 0.05, colour = "gray", fill = "gray") +
  theme_bw() +
...
p2 <- ggplot2::ggplot(df_visits, aes(x = site_visit_rate_B)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = 0.05, colour = "lightblue2", fill = "lightblue2") +
  theme_bw() +
  scale_x_continuous(name = "Site Visit Rate (per year)",
                     limits = c(0, max(df_visits$site_visit_rate_C)+0.05)) +
  ylab("Frequency") +
...
p3 <- ggplot2::ggplot(df_visits, aes(x = site_visit_rate_C)) +
  geom_histogram(aes(y = after_stat(density)), binwidth = 0.05, colour = "royalblue3", fill = "royalblue3") +
  theme_bw() +
  scale_x_continuous(name = "Site Visit Rate (per year)",
                     limits = c(0, max(df_visits$site_visit_rate_C)+0.05)) +
  ylab("Frequency") +
